...
function iOS(build, agent) {
    ...
    this.build_dir = path.resolve(this.workFolder, "platforms/ios/build/device/");
...
iOS.define({
    ...
    init: function(build) {
        this.agent.genericBuild(build, this.filesDone.bind(this), this.buildDone.bind(this), this.execCordovaBuild);
    },
